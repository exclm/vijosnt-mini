...
Namespace Compiling
    Friend Class Compiler
        ...
        Public ReadOnly Property TimeQuota() As Nullable(Of Int64)
            Get
                Return m_TimeQuota
            End Get
        End Property

        Public ReadOnly Property MemoryQuota() As Nullable(Of Int64)
            Get
                Return m_MemoryQuota
            End Get
        End Property

        Public ReadOnly Property ActiveProcessQuota() As Nullable(Of Int32)
            Get
        ...
        Public ReadOnly Property TimeOffset() As Nullable(Of Int64)
            Get
                Return m_TimeOffset
            End Get
        End Property

        Public ReadOnly Property TimeFactor() As Nullable(Of Double)
            Get
                Return m_TimeFactor
            End Get
        End Property

        Public ReadOnly Property MemoryOffset() As Nullable(Of Int64)
            Get
                Return m_MemoryOffset
            End Get
        End Property

        Public ReadOnly Property MemoryFactor() As Nullable(Of Double)
            Get
